        ...
        <>
          ...
          <div className="lead-actions">
            ...
            <div className="action-buttons">
              ...
              <Link to={`/calculator?leadId=${id}&tab=history`} className="btn btn-sm" style={{ textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '0.3rem', background: 'var(--bg-tertiary)', color: 'var(--text-primary)', border: '1px solid var(--border-subtle)' }}>
                🕘 History
              </Link>
