...
const STAGE_TRANSITIONS = {
  ...
  'UNDER_CONTRACT→INSPECTION_PERIOD': { stageNumber: 13, workflow: 'wf_under_contract_tc_handoff', owner: 'TC', name: 'Under Contract → Inspection Period', description: 'TC handshake email (BGonzalez + monique). 14-day countdown. Day 7 SMS. Day 14 Kayla alert.', automations: [{ type: 'webhook', endpoint: '/webhook/ghl/stage-transition' }, { type: 'copy_email', to: 'BGonzalez@sellsmartre.com,monique@prolificbuyer.com', subject: 'TC Handoff - {{address}}', bodyTemplate: 'Inspection period started for {{address}}. 14-day countdown begins. Day 7 SMS to seller scheduled. Day 14 alert to Kayla.' }, { type: 'set_reminder', reminder_type: 'inspection_day_7_sms', offset_days: 7 }, { type: 'set_reminder', reminder_type: 'inspection_day_14_kayla_alert', offset_days: 14 }, { type: 'set_reminder', reminder_type: 'inspection_period_end', offset_days: 14 }, { type: 'log', message: 'Stage 13: TC handshake sent. 14-day countdown started. Day 7 SMS + Day 14 Kayla alert scheduled.' }], ghl_actions: ['Send Email', 'Wait', 'Create Task'] },
